...
export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-16 space-y-6">
      ...
      <p className="text-muted-foreground leading-relaxed">כסף חזרה היא פלטפורמה טכנולוגית ישראלית לאוטומציה של תהליך בקשת החזר המס. אנחנו מאמינים שכל שכיר בישראל זכאי להחזיר את הכסף שמגיע לו — ללא בירוקרטיה מסובכת.</p>
