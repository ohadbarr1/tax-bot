      ...
      return (
        ...
        >
          <div className="max-w-md w-full bg-card rounded-2xl shadow-lg p-8 text-center space-y-4">
            ...
            <h2 className="text-xl font-semibold text-kc-ink">
              משהו השתבש
            </h2>
            ...
            <button
              ...
              className="mt-2 px-5 py-2 bg-kc-ink text-white text-sm font-medium rounded-xl hover:bg-kc-ink-soft transition-colors"
            >
              טען מחדש
            </button>
          </div>
