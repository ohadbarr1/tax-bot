  ...
  it("API route list is stable", () => {
    expect(apiRoutes).toMatchInlineSnapshot(`
      [
        ...
        "/api/metrics",
        "/api/mine/document",
        "/api/parse/disability-cert",
        "/api/parse/donation",
        "/api/parse/form-106",
        "/api/parse/form-161-inbound",
        "/api/parse/form-867-inbound",
        "/api/parse/ibkr",
        "/api/parse/life-insurance",
        "/api/parse/mil-service",
        "/api/parse/pension-fund",
        "/api/parse/tuition",
        "/api/parse/withholding-cert",
        "/api/user/delete",
